...
def parameter_identification(time, external_temp,wall_temp, Q_heat ,Q_cool, Q_in, internal_temp, vent_temp, vent_flow):
    ...
    #     initial_params,  # 初始参数
    #     args=(time, external_temp, Q_heat, Q_in, vent_temp, vent_flow, internal_temp),  # 其他参数
    #     bounds=bounds,  # 参数范围
    ...
    #     objective_function,
    #     bounds=bounds,
    #     args=(time, external_temp, Q_heat, Q_in, vent_temp, vent_flow, internal_temp)
    # )
    # 全局优化（差分进化）
    global_result = differential_evolution(
    objective_function,
    bounds=bounds,
    args=(time, external_temp,wall_temp, Q_heat ,Q_cool, Q_in, vent_temp, vent_flow, internal_temp),
    strategy='best1bin',
    maxiter=1000,
    popsize=20)
