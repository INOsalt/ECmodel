...
class ThermalModel:
    ...
    def predict(self, Tamb_t, Tin_t, Qin_t, step_pre, vent_flow, Tsp_high=24,Tsp_low=21):
        ...
        if Q_space > 0:  # 加热
            ...
            # **热平衡
            Q_space = Q_zone - Q_ahu - Q_zone_wall - Qin_t
            Q_space_heat = max(Q_space,0)
            Q_zone1 = Q_space_heat + Q_ahu + Q_zone_wall + Qin_t
            Tin_t1 = Tin_t + Q_zone1/C_zone * self.dt
        ...
        return Tin_t1, Twall_t1, T_vent, Q_zone, Q_ahu, Q_space_heat, Q_space_cool, Q_zone_wall
...
if __name__ == "__main__":
    ...
    # 执行预测
    Tin_t1, Twall_t1, Q_zone, Q_ahu, Q_space_heat, Q_space_cool = thermal_model.predict(Tamb_t, Tin_t, Qin_t, step_pre, vent_flow)
